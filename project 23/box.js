class Box{
    constructor(){
        ...
        this.bodyBottom=Bodies.rectangle(width/2,650,200,20,options);
        this.width1=200;
        this.height1=20;
        
        this.bodyLeft=Bodies.rectangle(300,610,20,100,options);
        this.width2=20;
        this.height2=100;

        this.bodyRight=Bodies.rectangle(500,610,20,100,options);
        this.width3=20;
        this.height3=100;
